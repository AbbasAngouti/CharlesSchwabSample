...
class BrowseViewController: UICollectionViewController, UISearchResultsUpdating {
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        return collectionView.dequeueReusableCellWithReuseIdentifier("BrowseCell", forIndexPath: indexPath)
    }
